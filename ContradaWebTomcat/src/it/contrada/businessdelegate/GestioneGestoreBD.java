...
public class GestioneGestoreBD {
	...
	static {
		/*
		if (gestioneGestore == null) {
			InitialContext ctx;
			try {
				ctx = new InitialContext();
				gestioneGestore = (IGestioneGestore) ctx
						.lookup("ContradaEAR/GestioneGestore/local");
	...
	public static List<GestoreDTO> elencaGestori() throws ContradaExceptionNonBloccante, ContradaExceptionBloccante
	{
